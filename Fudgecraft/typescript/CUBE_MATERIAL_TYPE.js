...
(function (FudgecraftGame) {
    let CUBE_MATERIAL_TYPE;
    (function (CUBE_MATERIAL_TYPE) {
        CUBE_MATERIAL_TYPE["GREEN"] = "green";
        CUBE_MATERIAL_TYPE["RED"] = "red";
        CUBE_MATERIAL_TYPE["BLUE"] = "Blue";
        CUBE_MATERIAL_TYPE["YELLOW"] = "Yellow";
